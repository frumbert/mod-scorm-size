...
M.mod_scorm.init = function(Y, hide_nav, hide_toc, toc_title, window_name, launch_sco, scoes_nav, nav_options) {
    scoes_nav = Y.JSON.parse(scoes_nav);
    nav_options = Y.JSON.parse(nav_options);

console.log("init", arguments, "nav", scoes_nav, "options", nav_options);
